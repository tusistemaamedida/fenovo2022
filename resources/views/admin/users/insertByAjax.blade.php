    ...
    <div class="form-group">
        <label class="text-dark" >Nickname</label>
        <input type="text" name="username" @if (isset($user)) value="{{$user->username}}" @else value="" @endif class="form-control" required autofocus>
    </div>
