<form>
    <div class="row">
        ...
        <div class="col-xs-12 col-md-8">
            ...
            <input type="hidden" name="cost_fenovo" id="cost_fenovo" value="{{ $cost_fenovo }}">
            <input type="hidden" name="unit_price" id="unit_price" value="{{ $unit_price }}">
            <input type="hidden" name="tasiva" id="tasiva" value="{{ $product->product_price->tasiva }}">
            ...
            <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <input type="text" name="unidades_{{ $stock_presentaciones[$i]['presentacion'] }}"
                                ...
                                class="form-control calculate text-center bg-white border-primary font-weight-bolder"
                        ...
                        @foreach ($ajustes as $ajuste)
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="radioAjuste{{ $ajuste['type'] }}" name="ajuste"
                                    class="custom-control-input" onclick="VerAjuste(this.value)"
                                    value="{{ $ajuste['type'] }}" @if ($loop->first) checked @endif>
                ...
                <tr>
                    ...
                    <th>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="radioOperacion2" name="operacion" class="custom-control-input"
                                onclick="VerOperacion(this.value)" value="resta" checked>
                            <label class="custom-control-label" for="radioOperacion2">RESTAR</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="radioOperacion1" name="operacion" class="custom-control-input"
                                onclick="VerOperacion(this.value)" value="suma">
                ...
                <tr>
                    ...
                    <th>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="radioTipo1" name="tipo" class="custom-control-input"
                                onclick="VerTipo(this.value)" value="F" checked>
                            <label class="custom-control-label" for="radioTipo1">FACTURADO</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="radioTipo2" name="tipo" class="custom-control-input"
                                onclick="VerTipo(this.value)" value="R">
                            <label class="custom-control-label" for="radioTipo2">REMITO</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="radioTipo3" name="tipo" class="custom-control-input"
                                onclick="VerTipo(this.value)" value="CyO">
