        ...
        <div class="form-group row">
                    ...
                    <select class="js-example-basic-single js-states form-control bg-transparent" name="categorie_id" id="categorie_id">
                        @foreach ($categories as $category)
                            <option value="{{$category->id}}"
                                @if (isset($product) && $product->categorie_id == $category->id) selected @endif>{{$category->name}}</option>
                        @endforeach
                    </select>
                </fieldset>
            </div>
                    ...
                    <select class="js-example-basic-single js-states form-control bg-transparent" name="type_id" id="type_id">
                        @foreach ($types as $type)
                            <option value="{{$type->id}}"
                                @if (isset($product) && $product->type_id == $type->id) selected @endif>
                                {{$type->name}}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    ...
                    @if (isset($product)) value="{{$product->cod_fenovo}}" @else value="" @endif class="form-control border-dark" onfocusout="validateCode()" >
                </fieldset>
            </div>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    ...
                    @if (isset($product)) value="{{$product->barcode}}" @else value="" @endif name="barcode" id="barcode">
                </fieldset>
            </div>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="text" class="form-control border-dark"
                    @if (isset($product)) value="{{$product->cod_cuenta_compra}}" @else value="" @endif name="cod_cuenta_compra" id="cod_cuenta_compra">
                </fieldset>
            </div>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="text" class="form-control border-dark"
                    @if (isset($product)) value="{{$product->cod_cuenta_venta}}" @else value="" @endif name="cod_cuenta_venta" id="cod_cuenta_venta">
                </fieldset>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group row">
                    ...
                    <select class="js-example-basic-single js-states form-control bg-transparent" name="proveedor_id" id="proveedor_id">
                        ...
                        @foreach ($proveedores as $proveedor)
                            <option value="{{$proveedor->id}}"
                                @if (isset($product) && $product->proveedor_id == $proveedor->id) selected @endif>{{$proveedor->name}}</option>
                        @endforeach
                    </select>
                </fieldset>
            </div>
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="text" class="form-control border-dark"
                    @if (isset($product)) value="{{$product->cod_proveedor}}" @else value="" @endif name="cod_proveedor" id="cod_proveedor">
                </fieldset>
            </div>
            ...
            <div class="col-md-3">
                ...
                <fieldset class="form-group mb-3">
                    <input type="number" class="form-control border-dark" @if (isset($product)) value="{{$product->stock_sem_min}}" @else value="2" @endif
            ...
            <div class="col-md-3">
                ...
                <fieldset class="form-group mb-3">
                    <input type="number" class="form-control border-dark" @if (isset($product)) value="{{$product->stock_sem_max}}" @else value="2" @endif
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="number" class="form-control border-dark" @if (isset($product)) value="{{$product->stock_min}}" @else value="100" @endif
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    ...
                    @if (isset($product)) value="{{$product->package_palet}}" @else value="" @endif>
                </fieldset>
            </div>
        ...
        <div class="form-group row">
            <div class="col-md-3">
                <div class="switch-h d-flex mb-3">
                    ...
                    <div class="custom-control switch custom-switch custom-control-inline mr-0">
                        ...
                        @if (isset($product) && $product->online_sale) checked="" @elseif((isset($product) && !$product->online_sale) ) unchecked="" @else checked=""  @endif  value="1">
            ...
            <div class="col-md-3">
                <div class="switch-h d-flex mb-3">
                    ...
                    <div class="custom-control switch custom-switch custom-control-inline mr-0">
                        ...
                        @if (isset($product) && $product->active) checked="" @elseif(isset($product) && !$product->active)) unchecked="" @else checked="" @endif value="1">
            ...
            <div class="col-md-3">
                <div class="switch-h d-flex mb-3">
                    ...
                    <div class="custom-control switch custom-switch custom-control-inline mr-0">
                        <input type="checkbox" class="custom-control-input" id="is_senasa"
                        @if (isset($product) && $product->is_senasa) checked=" " @else  unchecked="" @endif name="is_senasa" value="1">
                    ...
                    <select class="js-example-basic-single js-states form-control bg-transparent" name="senasa_id" >
                        ...
                        @foreach ($senasaDefinitions as $senasaDefinition)
                            <option value="{{$senasaDefinition->id}}"
                                @if (isset($product) && $product->senasa_id == $senasaDefinition->id) selected @endif
