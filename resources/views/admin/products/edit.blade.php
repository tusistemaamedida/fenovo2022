                        ...
                        <div class="col-xs-12 col-md-6">
                            <ul class="nav nav-pills mb-3" id="pills-tab1" role="tablist">
                                ...
                                <li class="nav-item mr-2" id="nav-item-precios">
                                    <a class="nav-link btn-dark shadow-none" id="detalle-tab-basic" data-toggle="pill"
                                        href="#detalle" role="tab" aria-controls="detalle" aria-selected="false">
                                        Detalles
                                    </a>
                                </li>
                                <li class="nav-item mr-2" id="nav-item-imagenes">
                                    <a class="nav-link btn-dark shadow-none" id="imagenes-tab-basic" data-toggle="pill"
                                        href="#imagenes" role="tab" aria-controls="imagenes" aria-selected="false">
                                        Imágenes
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="row">
                        <form method="POST" action="{{ route('product.update') }}" id="formData">
                            ...
                            @if (isset($product))
                                ...
                                <input type="hidden" name="fecha_actualizacion_activa" id="fecha_actualizacion_activa"
                                    value="{{ $fecha_actualizacion_activa }}">
                                <input type="hidden" name="fecha_actualizacion_label" id="fecha_actualizacion_label"
                                    value="{{ $fecha_actualizacion_label }}">
                            @else
