    ...
    <form id="formData">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <button type="button" class="btn btn-primary btn-actualizar" onclick="update('{{ route('ingresos.updateIngreso') }}')" style="float: right"><i class="fa fa-save"></i> Actualizar</button>
            </div>
        </div>
    </form>
</div>