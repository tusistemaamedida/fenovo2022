...
<div class="table-datapos">
    <div class="table-responsive">
        <table class=" table table-hover table-striped table-sm">
            ...
            @php
                $total += $total+($movimiento->product->product_price->costfenovo*$movimiento->bultos);
            @endphp
            ...
            <tr>
                ...
                <td class="text-center"> {{ number_format($movimiento->product->product_price->costfenovo*$movimiento->bultos,2, ',', '.') }}</td>
