                        ...
                        <form method="POST" action="{{ route('login') }}" class="pb-5 pt-5">
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-lg-10 col-9 pl-0">
                                    <input type="email" class="form-control bg-transparent text-dark border-0 p-0 h-20px font-size-h5 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="example@mail.com" id="exampleInputEmail1" aria-describedby="emailHelp">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-lg-10 col-9 pl-0">
                                    <input type="password" placeholder="......." class="form-control text-dark bg-transparent font-size-h4 border-0 p-0 h-20px @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" id="exampleInputPassword1">
