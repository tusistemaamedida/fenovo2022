...
class CalculatePrices extends FormRequest
{
    ...
    public function messages(){
        return [
            ...
            'descproveedor.max'         => 'El desc. proveedor debe ser menor a 100%!',
            'mupfenovo.numeric'         => 'El Markup Fenovo debe ser numérico!',
            'mupfenovo.max'         => 'El Markup Fenovo debe ser menor a 100%!',
            'contribution_fund.numeric' => 'El Fondo contribución debe ser numérico!',

            'contribution_fund.max' => 'El Fondo contribución debe ser menor a 100%!',
            ...
            'muplist1.max'          => 'El Markup lista 1 debe ser menor a 100%!',
            'muplist2.max'          => 'El Markup lista 2 debe ser menor a 100%!',
            ...
            'descp1.max'            => 'El Desc. mayorista debe ser menor a 100%!',
